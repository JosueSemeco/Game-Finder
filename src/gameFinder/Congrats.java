...
// BOTON X
		...
		JLabel error = new JLabel("FELICIDADES!");
		error.setBounds(60, 80, 650, 80);
		error.setFont(loadPixelFont("Hardpixel.OTF", 80));
		error.setForeground(new Color(255, 255, 240));
		this.add(error);
		
		// LABEL USUARIO VALIDO
		
		JLabel valido = new JLabel("COMPLETASTE EL JUEGO");
		valido.setBounds(40, 200, 545, 45);
		...
		volviendo.setBounds(45, 300, 545, 35);
